...
import pl.piegoose.songify.song.domain.service.SongDeleter;
import pl.piegoose.songify.song.domain.service.SongRetriever;
import pl.piegoose.songify.song.domain.service.SongUpdater;
...
public class SongRestController {
    ...
    public ResponseEntity<GetAllSongsResponseDto> getAllSongs(@RequestParam(required = false) Integer limit) {
        ...
        if (limit != null) {
            ...
            List<Song> limitedMap = songRetriever.findfindAllLimitedBy(limit);
